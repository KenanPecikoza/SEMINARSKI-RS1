    ...
    public class NastavnoOsobljeService : INastavnoOsobljeService
    {
        ...
        public NastavnoOsoblje Add(NastavnikDodajVM model)
        {
            ...
            NastavnoOsoblje nastavnoOsoblje = new NastavnoOsoblje
            {
                ...
                login = log,
                PhotoPath = FileUploadDelete.Upload(_hostingEnvironment, model.Photo, "images")
            };
        ...
        public NastavnoOsoblje Delete(int Id)
        {
            ...
            try
            {
                ...
                if (ulazniModel.PhotoPath != null)
                    FileUploadDelete.Delete(_hostingEnvironment, "images", ulazniModel.PhotoPath);
        ...
        public NastavnoOsoblje Update(NastavnikDodajVM model)
        {
            ...
            if (model.Photo != null)
            {
                if (osoblje.PhotoPath != null)
                    FileUploadDelete.Delete(_hostingEnvironment, "images", osoblje.PhotoPath);
                osoblje.PhotoPath = FileUploadDelete.Upload(_hostingEnvironment, model.Photo, "images", model.PhotoPath);
            }
